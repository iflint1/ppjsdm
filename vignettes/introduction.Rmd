...
```{r}
average_height <- c(type1 = 50, type2 = 70, type3 = 60)
average_seed_size <- c(type1 = 30, type2 = 15, type3 = 20)
...
```{r}
configurations <- append(ppjsdm::rppp(lambda = c(50, 50), 
                                      nsim = 1, 
                                      types = c("type1", "type2"), 
                                      drop = FALSE),
                         ppjsdm::rppp(lambda = c(50, 50), 
                                      nsim = 1,
                                      types = c("type2", "type3"), 
                                      drop = FALSE))
```
...
```{r}
fit <- ppjsdm::gibbsm(configurations, traits = traits)
```
