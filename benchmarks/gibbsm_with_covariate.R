...
b <- microbenchmark(
  "ppjsdm::gibbsm" = gibbsm(configuration, covariates = list(temperature = temperature), fitting_package = "glm", short_range = 0, dummy_factor = 1e6, max_dummy = nd * nd, print = FALSE),
