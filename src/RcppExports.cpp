...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(compute_vcov(configuration, covariates, model, medium_range_model, short_range, medium_range, long_range, saturation, alpha, beta0, beta, gamma, rho, coefficients_vector, shortened_regressors, data_list, estimate_alpha, estimate_gamma));
    return rcpp_result_gen;
END_RCPP
}
// has_duplicates
