...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(rgibbs_cpp(window, alpha, beta0, covariates, beta, gamma, short_range, medium_range, long_range, saturation, steps, nsim, types, model, medium_range_model, drop, mark_range, only_simulate_these_types, conditional_configuration, starting_configuration, seed, nthreads));
    return rcpp_result_gen;
END_RCPP
}
// rppp_cpp
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_ppjsdm_rgibbs_cpp", (DL_FUNC) &_ppjsdm_rgibbs_cpp, 22},
