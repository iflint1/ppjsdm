...
compute_A2_A3 <- function(configuration, covariates, model, medium_range_model, short_range, medium_range, long_range, saturation, alpha, beta0, beta, gamma, rho, t_over_papangelou, coefficients_vector, regressors) {
    .Call('_ppjsdm_compute_A2_A3', PACKAGE = 'ppjsdm', configuration, covariates, model, medium_range_model, short_range, medium_range, long_range, saturation, alpha, beta0, beta, gamma, rho, t_over_papangelou, coefficients_vector, regressors)
}
