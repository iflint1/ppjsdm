...
compute_A2_A3 <- function(configuration, covariates, model, medium_range_model, short_range, medium_range, long_range, saturation, alpha, lambda, beta, gamma, rho, area, t_over_papangelou) {
    .Call('_ppjsdm_compute_A2_A3', PACKAGE = 'ppjsdm', configuration, covariates, model, medium_range_model, short_range, medium_range, long_range, saturation, alpha, lambda, beta, gamma, rho, area, t_over_papangelou)
}
...
make_default_model_parameters <- function(alpha, lambda, covariates, beta, gamma, short_range, medium_range, long_range, types) {
    .Call('_ppjsdm_make_default_model_parameters', PACKAGE = 'ppjsdm', alpha, lambda, covariates, beta, gamma, short_range, medium_range, long_range, types)
}
